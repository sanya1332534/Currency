...
def test_parse_monobank(mocker):
    ...
    monobank_data = [
        {"currencyCodeA": 840, "currencyCodeB": 980, "rateBuy": 37.30, "rateSell": 38.0098},
        {"currencyCodeA": 978, "currencyCodeB": 980, "rateBuy": 40.37, "rateSell": 41.0004},
        {"currencyCodeA": 978, "currencyCodeB": 840, "rateBuy": 1.075, "rateSell": 1.09},
    ]
    requests_get_mock = mocker.patch(
        'requests.get',
...
def test_parse_monobank_prevent_duplicates(mocker):
    ...
    Rate.objects.create(source=source, buy="37.30", sell="38.00", currency_type=CurrencyTypeChoices.USD)
    Rate.objects.create(source=source, buy="40.37", sell="41.00", currency_type=CurrencyTypeChoices.EUR)
